...
0d11329  Redesign all index.html SVGs: white bg + consistent line art
56075c1  Add hero showcase + 6 heritage card SVG previews to index.html
cd0fd67  Add STATUS.md — project checkpoint 2026-02-21
...
### Phase 4 — Real Product Images (`0634fcc`)

SVG placeholder divs replaced with real externally-hosted images across the full site:

**index.html — 6 Heritage Card Previews:**
| Card | Image Source |
|------|-------------|
| TDK → Fabrion (AI Systems) | TDK.com factory management photo |
| Ogilvy → Slalom (Agency) | Audi Technology Portal — Q4 e-tron AR HUD diagram |
| Denon / Marantz (Audio) | Denon.com — AVR-A1H flagship receiver nav image |
| Miselu C.24 (Hardware) | Engadget hands-on via Yimg CDN |
| Beatport → NI (Music) | Native Instruments — Traktor Pro 4 hero |
| QuarkXPress (Publishing) | Wikimedia Commons CC-BY layout screenshot |

**projects.html — 11 of 14 Case Entry Thumbnails** (3 proprietary remain as placeholders: fabrion, ai-workflow, rakuten-fit)

**11 Case Study Hero Images:**
- `tdk.html` — TDK SensEI factory floor
- `ogilvy.html` — Audi Q4 e-tron AR HUD working principle
- `slalom.html` — Gundam Metaverse official hero (gmpj.bn-ent.net)
- `denon-marantz.html` — Denon AVR flagship
- `miselu.html` — Miselu C.24 keyboard product photo
- `beatport-ni.html` — Traktor Pro 4 DJ software
- `robot-heart.html` — Robot Heart + The Man (dusttoashes.com)
- `techcrunch.html` — Disrupt SF 2016 winner announcement
- `festivals.html` — EDC Las Vegas 2022 (Insomniac CloudFront)
- `quarkxpress.html` — QuarkXPress layout (Wikimedia CC)
- `kyoto-archive.html` — Kunichika ukiyo-e print (ukiyo-e.org public domain)

**Implementation notes:**
- Images injected as `<img>` tags with `loading="lazy/eager"` + `object-fit: cover`
- CSS in `case-study.css` already had `.cs-hero__image img` rule with `position:absolute;inset:0`
- Heritage card previews: inline style `object-fit:cover; border-radius:8px`
- Projects.html: img injected before canvas animation with `z-index:0; opacity:0.85`
- Hero showcase SVG on index.html remains as line-art (no single replacing image)
...
### Immediate
- [x] ~~Replace image placeholders with real photography/screenshots~~ (Phase 4 complete — 11/14 case studies, all 6 heritage cards, 11/14 project thumbnails)
- [ ] Replace 3 remaining proprietary placeholders with Figma screenshots when available (fabrion, ai-workflow, rakuten-fit)
